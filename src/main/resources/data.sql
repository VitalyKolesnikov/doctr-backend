...
INSERT INTO visits (doctor_id, patient_id, clinic_id, visit_date, cost, info)
VALUES (1000, 1004, 1008, '2020-10-15', 1340050, 'Каналы 26'),
       (1000, 1004, 1009, '2021-01-23', 270075, 'Пломба 25'),
       (1000, 1005, 1009, '2021-02-12', 420000, 'Пломба 34');
