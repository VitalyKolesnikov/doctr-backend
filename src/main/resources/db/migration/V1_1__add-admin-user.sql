...
INSERT INTO public.users (id, username, password, first_name, middle_name, last_name, email, phone, birth_date, created, updated, status) VALUES (1001, 'admin', '$2a$12$TImIkMgSknPffCH1YFg7m.bg4KvYjA.fcMtj18bXmM8rR2a0qIk5O', 'admin', null, 'admin', 'email', 'phone', null, '2021-02-21 19:41:10.430535', '2021-02-21 19:41:10.430535', 'ACTIVE');
